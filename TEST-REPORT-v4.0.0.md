...
## Addendum (2026-09-06, post-test policy change)

Rows referencing `README.zh.md` reflect the state at test time. The Chinese
README was subsequently removed under the repository no-Chinese policy
(commit b674dc1), and the testing convention in AGENTS.md now requires a
single English README. The historical rows above are retained unchanged for
trend comparison.
