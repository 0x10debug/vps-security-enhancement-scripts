...
| L3 | Data security (database hardening, big-data SSL/audit) | Database hardening (MySQL/PG/Redis/Mongo) added |
...
14 scenario-driven chapters organized by security layer. Each follows "Problem → Investigate → Fix → Verify":
