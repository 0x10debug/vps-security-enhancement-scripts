...
| Layer | Scope | Status |
|---|---|---|
| L0 | Compliance audit (CIS Benchmark, STIG) | Planned (Phase 2) |
...
8 scenario-driven chapters organized by security layer. Each follows "Problem → Investigate → Fix → Verify":
